...
def ask_project_bot(query: str, history: list, project_path: str = None) -> tuple[str, list]:
    ...
    context = (
        ...
        "```\n"
        "The system will automatically intercept this block and overwrite the file on the user's hard drive.\n"
        "Always use the exact absolute path provided in the context below.\n\n"
        "### Project Context\n"
